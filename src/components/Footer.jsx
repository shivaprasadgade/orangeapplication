    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-orange-400">Orange Fashion</h3>
            <p className="mb-4">Your one-stop shop for premium clothing.</p>
            <div className="flex space-x-4">
              <a 
                href="https://www.instagram.com/orange_fashionsknr/" 
                target="_blank" 
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p>&copy; {new Date().getFullYear()} Orange Fashion. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
